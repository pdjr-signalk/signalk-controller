module.exports = class Programme {
    ...
    async getSeasonNames(callback) {
        ...
        seasons = await this.options.storage.getItem("seasons");
    ...
    getProtocol() {
        if (this.options.debug) console.log("Programme.getProtocol()...");
        ...
        return({
            ...
            verbs: {
	            saveEvent: {
	                requires: [ 'e' ],
	                returns: null,
	                func: function(params) { this.saveEvent(params.e); }.bind(this)
	            },
	            removeEvent: {
	                requires: [ 'e' ],
	                returns: null,
	                func: function(params) { this.removeEvent(params.e); }.bind(this)
	            },
	            getEventsForWeek: {
	                requires: [ 'date' ],
	                returns: 'events',
	                func: function(params, callback) { this.getEventsForWeek(params.date, callback); }.bind(this)
	            },
	            getEventsForSeason: {
	                requires: [ 'season', 'date' ],
	                returns: 'events',
	                func: function(params, callback) { this.getEventsForSeason(params.season, params.date, callback); }.bind(this)
	            },
	            saveSeason: {
	                requires: [ 'season', 'events' ],
	                returns: null,
	                func: function(params) { this.saveSeason(params.season, params.events); }.bind(this)
	            },
	            getCurrentSeasonName: {
	                requires: [ 'date' ],
	                returns: 'seasonName',
	                func: function(params, callback) { this.getCurrentSeasonName(params.date, callback); }.bind(this)
	            },
	            getSeasonNames: {
	                requires: [],
	                returns: null,
	                func: function(params, callback) { this.getSeasonNames(callback); }.bind(this)
	            }
            }
	    });
    }
