...
module.exports = class Controller extends Schedule {
            ...
            if ((this.state.channels[channel]) && (['ON','OFF','AUTO','1H','2H','ADVANCE'].includes(mode))) {
                ...
                switch (mode) {
                    ...
                    case '1H':
                        ...
                        var e = new CanonicalEvent(offtime, 'OFF', this.scheduleJob(offtime, function(ch) { this.setChannelMode(ch,'OFF'); }.bind(this, channel)));
    ...
    cancelJobsOnChannel(channelName) {
        ...
        //console.log(JSON.stringify(this.state.channels[channelName].events));

        this.state.channels[channelName].events.forEach(e => { console.log(typeof e); e.cancel(); });
